  ...
  if (results.length === 0) {
    ...
    results.forEach((song) => {
      ...
      row.innerHTML = `
        ...
        <td id="action">
                  <!-- edit button -->
                  <button class="action-button" id="pencil-button">
                    <svg style="fill: #D7176C;" xmlns="http://www.w3.org/2000/svg" height="1em"
                  ...
                  <!-- delete button -->
                  <button class="action-button" id="trash-button" style="fill: #D7176C;">
                    <svg style="fill: #D7176C;" xmlns="http://www.w3.org/2000/svg" height="1em"
